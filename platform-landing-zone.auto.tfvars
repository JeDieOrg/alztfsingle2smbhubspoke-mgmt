...
management_group_settings = {
  ...
  subscription_placement = {
    ...
    #   management_group_name = "identity-tf-smb-hubspoke-single2"
    # }
    connectivity = {
      subscription_id       = "$${subscription_id_connectivity}"
      management_group_name = "connectivity-tf-smb-hubspoke-single2"
    }
    management = {
      subscription_id       = "$${subscription_id_management}"
      management_group_name = "management-tf-smb-hubspoke-single2"
    }
    ...
    #   management_group_name = "security-tf-smb-hubspoke-single2"
    # }
  }
  policy_assignments_to_modify = {
    alz-tf-smb-hubspoke-single2 = {
      policy_assignments = {
